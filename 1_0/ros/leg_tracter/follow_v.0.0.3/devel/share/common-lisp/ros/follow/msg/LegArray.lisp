...
(cl:defclass <LegArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (legs
    :reader legs
    :initarg :legs
    :type (cl:vector follow-msg:Leg)
   :initform (cl:make-array 0 :element-type 'follow-msg:Leg :initial-element (cl:make-instance 'follow-msg:Leg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LegArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LegArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name follow-msg:<LegArray> is deprecated: use follow-msg:LegArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <LegArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader follow-msg:header-val is deprecated.  Use follow-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'legs-val :lambda-list '(m))
(cl:defmethod legs-val ((m <LegArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader follow-msg:legs-val is deprecated.  Use follow-msg:legs instead.")
  (legs m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LegArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'legs)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'follow-msg:Leg))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LegArray>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%Leg[] legs~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: follow/Leg~%geometry_msgs/Point position~%float32 confidence~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LegArray)))
  "Returns full string definition for message of type 'LegArray"
  (cl:format cl:nil "std_msgs/Header header~%Leg[] legs~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: follow/Leg~%geometry_msgs/Point position~%float32 confidence~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
