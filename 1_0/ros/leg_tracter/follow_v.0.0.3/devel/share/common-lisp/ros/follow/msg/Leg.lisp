...
(cl:defmethod cl:initialize-instance :after ((m <Leg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Leg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name follow-msg:<Leg> is deprecated: use follow-msg:Leg instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Leg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader follow-msg:position-val is deprecated.  Use follow-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <Leg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader follow-msg:confidence-val is deprecated.  Use follow-msg:confidence instead.")
  (confidence m))
