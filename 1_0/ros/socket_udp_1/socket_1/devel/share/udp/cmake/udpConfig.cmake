...
if("TRUE" STREQUAL "TRUE")
  set(udp_SOURCE_PREFIX /home/tbf/projects/demo/2_0/ros/socket_1/src/udp)
  set(udp_DEVEL_PREFIX /home/tbf/projects/demo/2_0/ros/socket_1/devel)
  set(udp_INSTALL_PREFIX "")
  set(udp_PREFIX ${udp_DEVEL_PREFIX})
else()
  set(udp_SOURCE_PREFIX "")
  set(udp_DEVEL_PREFIX "")
  set(udp_INSTALL_PREFIX /home/tbf/projects/demo/2_0/ros/socket_1/install)
...
if(NOT "/home/tbf/projects/demo/2_0/ros/socket_1/src/udp/include;/home/tbf/projects/demo/2_0/ros/socket_1/src/udp/protobuf " STREQUAL " ")
  set(udp_INCLUDE_DIRS "")
  set(_include_dirs "/home/tbf/projects/demo/2_0/ros/socket_1/src/udp/include;/home/tbf/projects/demo/2_0/ros/socket_1/src/udp/protobuf")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'udp' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'udp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tbf/projects/demo/2_0/ros/socket_1/src/udp/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tbf/projects/demo/2_0/ros/socket_1/devel/lib;/home/tbf/projects/demo/2_0/ros/socket_1/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${udp_dep}_FOUND)
      find_package(${udp_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${udp_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
